...
public class Demo {
    ...
    static String USER_sql = "CREATE TABLE USER("
    ...
    static String VEHICLE_sql = "CREATE TABLE VEHICLE("
    ...
    static String TIRE_sql = "CREATE TABLE TIRE("
            ...
            + "CONSTRAINT `TIRE_INIT_SS_ID_fk_SNAPSHOT_ID` FOREIGN KEY (`INIT_SS_ID`) REFERENCES `SNAPSHOT` (`ID`),"
            + "CONSTRAINT `TIRE_CUR_SS_ID_fk_SNAPSHOT_ID` FOREIGN KEY (`CUR_SS_ID`) REFERENCES `SNAPSHOT` (`ID`),"
            + "CONSTRAINT `TIRE_VEHICLE_ID_fk_VEHICLE_VIN` FOREIGN KEY (`VEHICLE_ID`) REFERENCES `VEHICLE` (`VIN`)"
            + ")charset=utf8;";

    static String SNAPSHOT_sql = "CREATE TABLE SNAPSHOT("
